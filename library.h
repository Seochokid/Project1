...
public:
	library();
	void resource_data();
	string check(int cnt, string dateS, string r_type, string r_name, string op, string m_type, string m_name);
	string check2(int cnt, string s_dateS, string s_type, int s_num, string s_op, string sm_type, string sm_name, int sm_num, int s_time, int hour);
